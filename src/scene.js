export function createDefaultScene() {
  return {
    ...
    lights: [
      ...
      { id: 'window-01', label: 'Window daylight', role: 'natural light', type: 'window', color: '#9bb8ff', intensity: 0.42, colorMix: 0.24, softness: 0.72, beamWidth: 0.7, gobo: 'window', x: 0.82, y: 0.22, targetIds: ['sofa-01'] },
